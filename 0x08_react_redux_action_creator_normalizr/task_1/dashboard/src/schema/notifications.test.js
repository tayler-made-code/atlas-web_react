...
describe('getAllNotificationsByUser', () => {
  test('returns the correct notifications for a user ID', () => {
...
describe('normalizedData', () => {
  test('has a correct result array', () => {
  ...
  test('has a correct users entity', () => {
    const userID = '5debd764a7c57c7839d722e9';
    const expectedUser = {
      age: 25,
  ...
  test('has a correct messages entity', () => {
  ...
  test('has a correct notifications entity', () => {
